...
const tags: Record<string, Tag> = {
  ai: {
    embeds: [
      new EmbedBuilder(universalEmbed)
        ...
        .setTitle('🚫 NO AI ZONE 🚫')
        .setDescription(
          "This server is a **NO AI** zone. We do not allow the use of AI-generated content, including but not limited to ChatGPT, Midjourney, DALL-E, and other similar tools. This includes asking for help with code, schematics, or any other content that can be generated by AI.\n\nWe believe in the value of human creativity and problem-solving skills. We encourage you to learn and grow by engaging with the community and seeking help from fellow members.\n\nIf you have questions or need assistance, please ask the community for help. We're here to support each other and learn together! \n\nThank you for respecting this rule and helping to maintain the integrity of our community by NOT using AI to reply to users, and if users are using AI for their project, do not assist!",
        )
        .setFooter({
          text: 'Help us keep this a NO AI zone!\n\nYou do them no favors by using AI, as it will stunt their growth and learning.',
        }),
    ],
  },
        ...
        .addFields(
          {
            ...
            value:
              "Explain **what your code or hardware is doing** and **what you want it to do instead**. Be as specific as possible. List hardware, code and any sources that you're following. If you have an error message, include it in your question.",
          },
          {
            name: '2️⃣ Share Your Code',
            value:
              'Sharing your code helps others understand your issue. Click the **"Codeblock"** button below to learn how to format and share your code properly.',
          },
          {
            name: '3️⃣ Be Patient and Polite',
            value:
              'Remember, no one here is paid to help you. Take the time to write a clear question, and be respectful while waiting for a response. Only ask for help in ONE channel, and be sure to have the project in front of you and time available to work on it before asking for help. Asking in multiple channels will not get you help faster and will only annoy people, and is against server rules.',
          },
        )
        .setFooter({
  ...
  avrdude: {
    embeds: [
      new EmbedBuilder(universalEmbed)
        ...
        .setDescription(
          "__avrdude: stk500__ ... Error is very common, and can be caused by many different things. Here are some steps to try to fix it. If you have tried all of these and it still doesn't work, please ask for help in the **#general-help channel.**",
        )
        .addFields(
          {
            name: '1. Is your Serial monitor, or any 3D printer software open?',
            value:
              'If it is, close it. This allows your IDE to upload sketches without conflicts with the Serial Monitor. Only have one IDE open at a time, as having multiple IDEs open can cause issues with the IDE. So close them all before uploading a sketch, and try restarting your PC.',
          },
          {
          ...
          },
          {
            ...
            value:
              "Select the right board and model in your IDE, and see if it's showing up in your device manager correctly.",
          },
          {
            name: '4. Is anything connected to your Tx and Rx pins?',
            value:
              'Removing everything connected to the tx and rx pins of your board. This includes any shields, modules, or wires connected to the Tx and Rx pins. If you are using a shield, make sure it is compatible with your board.\n' +
          ...
          },
          {
            ...
            value:
              "Some USB cables aren't capable of transferring data, and some may be faulty, so make sure to try a different one to see if it works! You should try plugging another device into the cable to see if data can pass through it.\n" +
              'APPLE computers sometimes have issues with their USB adapters. You need to try other adaptors or buy an official one for your MAC.',
          },
          {
      ...
      new EmbedBuilder(universalEmbed)
        ...
        .addFields(
          ...
          },
          {
            ...
            value:
              'Debouncing is a technique to ensure that only one action is registered for a single intentional press.\n\n**Common Software Debounce Method:**\n' +
          ...
          },
          {
            name: 'Key Takeaway',
            value:
              'If your project uses buttons, switches, or any mechanical contact that triggers an action, you almost certainly need to implement debouncing for reliable operation.',
          },
        ),
    ],
  },
      ...
      new EmbedBuilder(universalEmbed)
        ...
        .addFields(
          ...
          },
          {
            name: '2. Have you selected the right port in your IDE?',
            value:
              'You might have selected something that is **not** your ESP. Change the port in the Arduino IDE by going to **Tools** -> **Port**.',
          },
          {
            name: '3. Have you selected the right board in your IDE?',
          ...
          },
          {
            ...
            value:
              'Try setting it to the correct baud rate (At the bottom right corner of the Serial monitor). Most examples use 115200 baud.',
          },
          {
          ...
          },
          {
            ...
            value:
              'Unhook the board, wait 10 seconds, then try holding down the BOOT/IO0/FLASH button. Keep holding it down until **AFTER** its done compiling, and the IDE says "uploading".\n\nThen release the button. This puts the board into flash mode, and can sometimes help with communication issues.\n\nThe boards are so bad sometimes the buttons are labeled backwards, so try again with the other button if it has one.',
          },
          {
            name: '7. Are there any problems with your wiring?',
            value:
              'Check for any wiring errors or loose connections (Note: If you are using an FTDI Board, FTDI TX and RX pins must be cross-connected with the ESP Tx and Rx pins (TX goes to RX)).',
          },
          {
  ...
  help: {
    embeds: [
      new EmbedBuilder(universalEmbed)
        .setTitle('ℹ️ Bot Commands Help ℹ️')
        .setDescription(
          "Here's how to use the bot and a list of available commands.",
        )
        .addFields(
          {
            name: 'Usage',
            value:
              'To use a tag, type `/tag` followed by the command name. For example:\n```/tag ask```',
          },
          {
  ...
  hid: {
    embeds: [
      new EmbedBuilder({ ...universalEmbed })
        ...
        .setDescription(
          'You want to use your Arduino for a Human Interface Device? HID',
        )
        .addFields(
          {
          ...
          },
          {
            ...
            value:
              'Arduino has many boards that can be used as a mouse/keyboard natively. This is referred to as HID.\n\n' +
          ...
          },
          {
            ...
            value:
              'The Uno R3 can be used as a HID device, but it requires a special bootloader to be flashed onto the board. This is **not recommended**. It is better to use a board that is already HID compliant. __We do not help with this, or with recovering a board this has been done to already as, it normally ends up in an unusable device and is just a waste of time__ .',
          },
        ),
    ],
  },
  ...
  lab: {
    embeds: [
      new EmbedBuilder({ ...universalEmbed })
        ...
        .setDescription(
          'Building a good electronics lab is key to being a successful maker. Here are some recommendations for essential tools and supplies.',
        )
        .addFields(
          {
            name: 'Essential Lab Equipment',
            value:
              "For detailed information on Multimeters, Oscilloscopes, Power Supplies, Components, and Soldering Supplies, please visit our server's Wiki.",
          },
          {
            name: 'Wiki Link',
            value:
              '[Click here to visit the Lab Supplies section of our Wiki](https://wiki.arduinodiscord.cc/gettingStarted/lab-supplies)',
          },
        ),
    ],
  },
        ...
        .addFields(
          {
            ...
            value:
              "Many popular Arduino boards, like the Uno and Mega operate at **5 Volts (5V)**. This means their digital pins operate at 5V for a 'HIGH' signal, and they expect 5v in return **3.3v will not be recognized**.\n\nHowever, a lot of modern modules and sensors (like the NRF24L01, ESP8266, SD cards) are designed to operate at **3.3 Volts (3.3V)**. Their **input or GPIO** pins are often **NOT 5V tolerant** and they can **NOT reliably send 5v to devices** either.\n\n It's like someone whispering softly to someone who is hard of hearing. They cannot communicate consistently.  https://wiki.arduinodiscord.cc/hardwareGuides/logiclevel",
          },
          {
            name: 'What Happens if You Connect 5V to a 3.3V Pin?',
            value:
              "Sending a 5V signal directly to a 3.3V input pin on a module is like shouting too loudly into someone's sensitive ear. You're applying excessive voltage.\n\n**Consequences:**\n" +
          ...
          },
          {
            ...
            value:
              "A Logic Level Shifter is a small, inexpensive board that acts as a 'voltage translator' between your 5V Arduino and your 3.3V module.\n\n" +
      ...
      new EmbedBuilder({ ...universalEmbed })
        ...
        .addFields(
          ...
          },
          {
            ...
            value:
              'Check for any capitalization errors as well! Also there is a difference in the way you include libraries: if you are using a library that is not in the Library Manager, you need to use `#include <yourlib.h>` instead of `#include "yourlib.h"`.',
          },
          {
            name: '3. Did you download it manually?',
            value:
              "If you downloaded it from GitHub or somewhere else and it came as a zip file, do not open the zip. Instead, open the IDE, go to Libraries -> Install from ZIP, then point to the zip folder and install. Then close all IDEs you have open, wait 20 seconds, then open the IDE, go to Libraries and see if it's now listed there. It should be.",
          },
          {
          ...
          },
          {
            ...
            value:
              'Check out [this Arduino forum post](https://forum.arduino.cc/t/no-headers-files-h-found/596090#:~:text=This%20might%20be%20result%20from,one%20of%20the%20libraries%20folders.) for more assistance.',
          },
        ),
    ],
  },
  ...
  needinfo: {
    content: (user?: string) =>
      ...
      'To get the best help, please provide the following:\n\n' +
      ...
      'The more details you provide, the faster and better we can help you!',
    botCommandsOnly: false,
  },
  ...
  reinstall: {
    embeds: [
      new EmbedBuilder(universalEmbed)
        ...
        .setDescription(
          'A clean reinstall of the Arduino IDE can often resolve unexpected issues. Follow these steps carefully to ensure a complete reinstallation.',
        )
        .addFields(
          {
            name: '1️⃣ Download the Latest Version',
            value:
              'Before you begin, download the latest official Arduino IDE from the [Arduino website](https://www.arduino.cc/en/Main/Software). This ensures you have the installer ready to go.',
          },
          {
            name: '2️⃣ Uninstall the Current Version',
            value:
              "Use your operating system's standard procedure to uninstall the Arduino IDE. This usually involves the 'Add or remove programs' on Windows or dragging the application to the Trash on macOS.",
          },
          {
            name: '3️⃣ Remove Old Configuration Files',
            value:
              'This is a crucial step to remove any corrupted settings. **Please back up any custom files or sketches you have saved in these folders before deleting.**\n\n' +
              '**Windows:**\n' +
          ...
          },
          {
            ...
            value:
              'Run the installer you downloaded in the first step. Follow the on-screen instructions to complete the installation. **NOTE:** *Do NOT install it to a cloud storage location like Google Drive or Dropbox.*',
          },
          {
            name: '5️⃣ Verify the Installation',
            value:
              'Once installed, open the Arduino IDE to ensure it starts correctly. You may need to reinstall your boards and libraries through the Boards Manager and Library Manager.',
          },
        ),
    ],
  },
  ...
  wiki: {
    embeds: [
      new EmbedBuilder(universalEmbed)
        ...
        .setDescription(
          'Our community wiki is a great resource for Arduino basics and tutorials.',
        )
        .addFields(
          {
          ...
          },
          {
            name: 'Visit the Wiki',
            value:
              '[Click here to explore the wiki](https://wiki.arduinodiscord.cc/)',
          },
        ),
    ],
  },
